"""Rename the physical table from courses_category to categories_category.

Step 3 of 3 in moving Category out of `courses`.

Now that `courses` has released the model (courses.0002) this is safe to run
...
the foreign key constraints from courses_course and onboarding_creatorprofile
...
class Migration(migrations.Migration):
    dependencies = [
        ...
        # Must run after courses drops Category from its state, otherwise two
        # apps would briefly claim the same table.
