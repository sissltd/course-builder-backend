...
_PERMISSIONS = (
    ...
    PermissionDef(
        c.TEAMS_SUSPEND,
        "Suspend Account",
        "Suspend, deactivate or reinstate a non-staff account.",
        "teams",
        is_design_chip=True,
    ),
    PermissionDef(
        ...
        "Delete Account",
        "Permanently delete a non-staff account and erase its personal data.",
        "teams",
        is_design_chip=True,
    ),
    PermissionDef(
        ...
        "Reset Password",
        "Email a non-staff account holder a password reset link.",
        "teams",
        is_design_chip=True,
    ),
    # APE pipeline & MIE
