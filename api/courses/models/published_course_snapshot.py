...
class PublishedCourseSnapshot(
    ...
    version = models.ForeignKey(
        ...
        help_text=_("CourseVersion lookup record this snapshot is published under."),
    )
    ...
    class Meta:
        verbose_name = _("Published Course Snapshot")
        verbose_name_plural = _("Published Course Snapshots")
